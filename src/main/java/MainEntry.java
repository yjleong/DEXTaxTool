    ...
    public static void main(String[] args) {
        try {
            ...
            if (!etherscanNormalTxn.status.equals("1") || !etherscanNormalTxn.message.equals("OK")) {
                ...
                tempBalance.add(new Balance(300000000000000000d, 1582259618, "ETH"));
                HashMap<String, Queue<Balance>> tempInitBalance = new HashMap<String, Queue<Balance>>();
                tempInitBalance.put("ETH", tempBalance);
                txnProcessor.setInitBalances(tempInitBalance);
                LinkedList<Form8949Obj> form8949 = new LinkedList<Form8949Obj>();
                txnProcessor.processTxns(etherscanNormalTxn, etherscanInternalTxn, etherscanERC20Txn, form8949);
